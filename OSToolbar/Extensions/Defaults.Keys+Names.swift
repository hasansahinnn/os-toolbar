...
extension Defaults.Keys {
  ...
  static let menuIcon = Key<MenuIcon>("menuIcon", default: .ostoolbar)
  ...
  // Screenshot module
  static let screenshotDirectoryBookmark = Key<Data?>("screenshotDirectoryBookmark", default: nil)
  ...
  static let size = Key<Int>("historySize", default: 100)
